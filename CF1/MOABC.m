...
xRange = xboundary('CF1',nVar); % Decision Variables UpperBound And LowerBound

%% Bees Algorithm Parameters

nPop = 40; % Polpulation Size
...
epsilon = .001;   % Epsilon Size
alpha=0.1;      % Inflation Rate

Max_Trial = 100; % Maximum Trial Limit For Improve(Else Reset By Scout Bees)
